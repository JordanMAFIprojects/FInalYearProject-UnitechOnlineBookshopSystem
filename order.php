...
<ul class="nav nav-tabs" role="tablist">
  <li class="active"><a href="#data1" role="tab" data-toggle="tab">New Orders</a></li>
  <li><a href="#data2" role="tab" data-toggle="tab">Stored Orders</a></li>
  <li><a href="#data3" role="tab" data-toggle="tab">Delivered Orders</a></li>
</ul>
        ...
        <table class="table table-bordered">
            ...
            <?php while($row = mysql_fetch_array($delivered)){ ?>
                <tr>
                    ...
                    <td class="text-center"><a href="order.php?p=paid&&id=<?php echo $row['id']; ?>" class="btn btn-warning">Delivered</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
